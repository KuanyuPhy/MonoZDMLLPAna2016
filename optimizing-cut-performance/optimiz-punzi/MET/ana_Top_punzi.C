...
void ana_Top_punzi(const char *scanMet_step = "tmp", TString outputfile = "./output/tmp.root")
{
    ...
    for (int evt = 0; evt < T_TTTo2L2Nu_tree->GetEntries(); evt++)
    {
        ...
        // Scan Met
        //-------------------
        h_pass_Bg->Fill(atoi(scanMet_step), I_TTTo2L2Nu_weight * merge_weight.ee_TTTo2L2NuWeight);
        if (f_TTTo2L2Nu_met > metcut)
        {
            h_pass_Bg_nMetcut->Fill(atoi(scanMet_step), I_TTTo2L2Nu_weight * merge_weight.ee_TTTo2L2NuWeight);
        }
    }
    ...
    for (int evt = 0; evt < T_ST_tW_top_tree->GetEntries(); evt++)
    {
        ...
        // Scan Met
        //-------------------
        h_pass_Bg->Fill(atoi(scanMet_step), I_ST_tW_top_weight * merge_weight.ee_ST_tW_topWeight);
        if (f_ST_tW_top_met > metcut)
        {
            h_pass_Bg_nMetcut->Fill(atoi(scanMet_step), I_ST_tW_top_weight * merge_weight.ee_ST_tW_topWeight);
        }
    }
    ...
    for (int evt = 0; evt < T_ST_tW_antitop_tree->GetEntries(); evt++)
    {
        ...
        // Scan Met
        //-------------------
        h_pass_Bg->Fill(atoi(scanMet_step), I_ST_tW_antitop_weight * merge_weight.ee_ST_tW_antitopWeight);
        if (f_ST_tW_antitop_met > metcut)
        {
            h_pass_Bg_nMetcut->Fill(atoi(scanMet_step), I_ST_tW_antitop_weight * merge_weight.ee_ST_tW_antitopWeight);
        }
    }
    ...
    for (int evt = 0; evt < T_TTWJetsToLNu_tree->GetEntries(); evt++)
    {
        ...
        // Scan Met
        //-------------------
        h_pass_Bg->Fill(atoi(scanMet_step), I_TTWJetsToLNu_weight * merge_weight.ee_TTWJetsToLNuWeight);
        if (f_TTWJetsToLNu_met > metcut)
        {
            h_pass_Bg_nMetcut->Fill(atoi(scanMet_step), I_TTWJetsToLNu_weight * merge_weight.ee_TTWJetsToLNuWeight);
        }
    }
    ...
    for (int evt = 0; evt < T_TTWJetsToQQ_tree->GetEntries(); evt++)
    {
        ...
        // Scan Met
        //-------------------
        h_pass_Bg->Fill(atoi(scanMet_step), I_TTWJetsToQQ_weight * merge_weight.ee_TTWJetsToQQWeight);
        if (f_TTWJetsToQQ_met > metcut)
        {
            h_pass_Bg_nMetcut->Fill(atoi(scanMet_step), I_TTWJetsToQQ_weight * merge_weight.ee_TTWJetsToQQWeight);
        }
    }
    ...
    for (int evt = 0; evt < T_TTZToQQ_tree->GetEntries(); evt++)
    {
        ...
        // Scan Met
        //-------------------
        h_pass_Bg->Fill(atoi(scanMet_step), I_TTZToQQ_weight * merge_weight.ee_TTZToQQWeight);
        if (f_TTZToQQ_met > metcut)
        {
            h_pass_Bg_nMetcut->Fill(atoi(scanMet_step), I_TTZToQQ_weight * merge_weight.ee_TTZToQQWeight);
        }
    }
    ...
    for (int evt = 0; evt < T_TTZToLLNuNu_tree->GetEntries(); evt++)
    {
        ...
        // Scan Met
        //-------------------
        h_pass_Bg->Fill(atoi(scanMet_step), I_TTZToLLNuNu_weight * merge_weight.ee_TTZToLLNuNuWeight);

        if (f_TTZToLLNuNu_met > metcut)
        {
            h_pass_Bg_nMetcut->Fill(atoi(scanMet_step), I_TTZToLLNuNu_weight * merge_weight.ee_TTZToLLNuNuWeight);
        }
    }
