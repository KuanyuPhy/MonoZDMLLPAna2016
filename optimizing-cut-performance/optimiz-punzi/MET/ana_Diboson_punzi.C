...
void ana_Diboson_punzi(const char *scanMet_step = "tmp", TString outputfile = "./output/tmp.root")
{
    ...
    for (int evt = 0; evt < T_event->GetEntries(); evt++)
    {
        ...
        // Scan Met
        //-------------------
        h_pass_Bg->Fill(atoi(scanMet_step), f_gg_ZZ_2e2mu_weight * merge_weight.ee_diboson_gg_ZZ_2e2mu_Weight);
        if (f_gg_ZZ_2e2mu_met > metcut)
        {
            h_pass_Bg_nMetcut->Fill(atoi(scanMet_step), f_gg_ZZ_2e2mu_weight * merge_weight.ee_diboson_gg_ZZ_2e2mu_Weight);
        }
    }
    TTree *T_event1;
    ...
    for (int evt = 0; evt < T_event1->GetEntries(); evt++)
    {
        ...
        // Scan Met
        //-------------------
        h_pass_Bg->Fill(atoi(scanMet_step), f_gg_ZZ_2e2nu_weight * merge_weight.ee_diboson_gg_ZZ_2e2nu_Weight);
        if (f_gg_ZZ_2e2nu_met > metcut)
        {
            h_pass_Bg_nMetcut->Fill(atoi(scanMet_step), f_gg_ZZ_2e2nu_weight * merge_weight.ee_diboson_gg_ZZ_2e2nu_Weight);
        }
    }
    TTree *T_event2;
    ...
    for (int evt = 0; evt < T_event2->GetEntries(); evt++)
    {
        ...
        // Scan Met
        //-------------------
        h_pass_Bg->Fill(atoi(scanMet_step), f_gg_ZZ_2e2tau_weight * merge_weight.ee_diboson_gg_ZZ_2e2tau_Weight);
        if (f_gg_ZZ_2e2tau_met > metcut)
        {
            h_pass_Bg_nMetcut->Fill(atoi(scanMet_step), f_gg_ZZ_2e2tau_weight * merge_weight.ee_diboson_gg_ZZ_2e2tau_Weight);
        }
    }
    TTree *T_event3;
    ...
    for (int evt = 0; evt < T_event3->GetEntries(); evt++)
    {
        ...
        // Scan Met
        //-------------------
        h_pass_Bg->Fill(atoi(scanMet_step), f_gg_ZZ_2mu2nu_weight * merge_weight.ee_diboson_gg_ZZ_2mu2nu_Weight);
        if (f_gg_ZZ_2mu2nu_met > metcut)
        {
            h_pass_Bg_nMetcut->Fill(atoi(scanMet_step), f_gg_ZZ_2mu2nu_weight * merge_weight.ee_diboson_gg_ZZ_2mu2nu_Weight);
        }
    }
    TTree *T_event4;
    ...
    for (int evt = 0; evt < T_event4->GetEntries(); evt++)
    {
        ...
        // Scan Met
        //-------------------
        h_pass_Bg->Fill(atoi(scanMet_step), f_gg_ZZ_2mu2tau_weight * merge_weight.ee_diboson_gg_ZZ_2mu2tau_Weight);
        if (f_gg_ZZ_2mu2tau_met > metcut)
        {
            h_pass_Bg_nMetcut->Fill(atoi(scanMet_step), f_gg_ZZ_2mu2tau_weight * merge_weight.ee_diboson_gg_ZZ_2mu2tau_Weight);
        }
    }
    TTree *T_event5;
    ...
    for (int evt = 0; evt < T_event5->GetEntries(); evt++)
    {
        ...
        // Scan Met
        //-------------------
        h_pass_Bg->Fill(atoi(scanMet_step), f_gg_ZZ_4e_weight * merge_weight.ee_diboson_gg_ZZ_4e_Weight);
        if (f_gg_ZZ_4e_met > metcut)
        {
            h_pass_Bg_nMetcut->Fill(atoi(scanMet_step), f_gg_ZZ_4e_weight * merge_weight.ee_diboson_gg_ZZ_4e_Weight);
        }
    }
    TTree *T_event6;
    ...
    for (int evt = 0; evt < T_event6->GetEntries(); evt++)
    {
        ...
        // Scan Met
        //-------------------
        h_pass_Bg->Fill(atoi(scanMet_step), f_gg_ZZ_4mu_weight * merge_weight.ee_diboson_gg_ZZ_4mu_Weight);
        if (f_gg_ZZ_4mu_met > metcut)
        {
            h_pass_Bg_nMetcut->Fill(atoi(scanMet_step), f_gg_ZZ_4mu_weight * merge_weight.ee_diboson_gg_ZZ_4mu_Weight);
        }
    }
    TTree *T_event7;
    ...
    for (int evt = 0; evt < T_event7->GetEntries(); evt++)
    {
        ...
        // Scan Met
        //-------------------
        h_pass_Bg->Fill(atoi(scanMet_step), f_gg_ZZ_4tau_weight * merge_weight.ee_diboson_gg_ZZ_4tau_Weight);
        if (f_gg_ZZ_4tau_met > metcut)
        {
            h_pass_Bg_nMetcut->Fill(atoi(scanMet_step), f_gg_ZZ_4tau_weight * merge_weight.ee_diboson_gg_ZZ_4tau_Weight);
        }
    }
    TTree *T_event8;
    ...
    for (int evt = 0; evt < T_event8->GetEntries(); evt++)
    {
        ...
        // Scan Met
        //-------------------
        h_pass_Bg->Fill(atoi(scanMet_step), f_gg_WW_2L2Nu_weight * merge_weight.ee_diboson_gg_WW_2L2Nu_Weight);
        if (f_gg_WW_2L2Nu_met > metcut)
        {
            h_pass_Bg_nMetcut->Fill(atoi(scanMet_step), f_gg_WW_2L2Nu_weight * merge_weight.ee_diboson_gg_WW_2L2Nu_Weight);
        }
    }
    TTree *T_event9;
    ...
    for (int evt = 0; evt < T_event9->GetEntries(); evt++)
    {
        ...
        // Scan Met
        //-------------------
        h_pass_Bg->Fill(atoi(scanMet_step), f_qq_WW_2L2Nu_weight * merge_weight.ee_diboson_qq_WW_2L2Nu_Weight);
        if (f_qq_WW_2L2Nu_met > metcut)
        {
            h_pass_Bg_nMetcut->Fill(atoi(scanMet_step), f_qq_WW_2L2Nu_weight * merge_weight.ee_diboson_qq_WW_2L2Nu_Weight);
        }
    }
    TTree *T_event10;
    ...
    for (int evt = 0; evt < T_event10->GetEntries(); evt++)
    {
        ...
        // Scan Met
        //-------------------
        h_pass_Bg->Fill(atoi(scanMet_step), f_qq_WZ_2L2Q_weight * merge_weight.ee_diboson_qq_WZ_2L2Q_Weight);
        if (f_qq_WZ_2L2Q_met > metcut)
        {
            h_pass_Bg_nMetcut->Fill(atoi(scanMet_step), f_qq_WZ_2L2Q_weight * merge_weight.ee_diboson_qq_WZ_2L2Q_Weight);
        }
    }
    TTree *T_event11;
    ...
    for (int evt = 0; evt < T_event11->GetEntries(); evt++)
    {
        ...
        // Scan Met
        //-------------------
        h_pass_Bg->Fill(atoi(scanMet_step), f_qq_WZ_3LNu_weight * merge_weight.ee_diboson_qq_WZ_3LNu_Weight);
        if (f_qq_WZ_3LNu_met > metcut)
        {
            h_pass_Bg_nMetcut->Fill(atoi(scanMet_step), f_qq_WZ_3LNu_weight * merge_weight.ee_diboson_qq_WZ_3LNu_Weight);
        }
    }
    TTree *T_event12;
    ...
    for (int evt = 0; evt < T_event12->GetEntries(); evt++)
    {
        ...
        // Scan Met
        //-------------------
        h_pass_Bg->Fill(atoi(scanMet_step), f_qq_ZZ_2L2Nu_weight * merge_weight.ee_diboson_qq_ZZ_2L2Nu_Weight);
        if (f_qq_ZZ_2L2Nu_met > metcut)
        {
            h_pass_Bg_nMetcut->Fill(atoi(scanMet_step), f_qq_ZZ_2L2Nu_weight * merge_weight.ee_diboson_qq_ZZ_2L2Nu_Weight);
        }
    }
    TTree *T_event13;
    ...
    for (int evt = 0; evt < T_event13->GetEntries(); evt++)
    {
        ...
        // Scan Met
        //-------------------
        h_pass_Bg->Fill(atoi(scanMet_step), f_qq_ZZ_2L2Q_weight * merge_weight.ee_diboson_qq_ZZ_2L2Q_Weight);
        if (f_qq_ZZ_2L2Q_met > metcut)
        {
            h_pass_Bg_nMetcut->Fill(atoi(scanMet_step), f_qq_ZZ_2L2Q_weight * merge_weight.ee_diboson_qq_ZZ_2L2Q_Weight);
        }
    }
    TTree *T_event14;
    ...
    for (int evt = 0; evt < T_event14->GetEntries(); evt++)
    {
        ...
        // Scan Met
        //-------------------
        h_pass_Bg->Fill(atoi(scanMet_step), f_qq_ZZ_4L_weight * merge_weight.ee_diboson_qq_ZZ_4L_Weight);
        if (f_qq_ZZ_4L_met > metcut)
        {
            h_pass_Bg_nMetcut->Fill(atoi(scanMet_step), f_qq_ZZ_4L_weight * merge_weight.ee_diboson_qq_ZZ_4L_Weight);
        }
    }
