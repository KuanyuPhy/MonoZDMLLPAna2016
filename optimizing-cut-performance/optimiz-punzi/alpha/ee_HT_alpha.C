...
// void ee_HT_alpha()
{
    ...
    for (int evt = 0; evt < T_inclusive->GetEntries(); evt++)
    {
        ...
        ee_for_inclusive_sample(HT, jet_passalpha_cut, merge_weight, I_ht0_weight, h_Bg_nJet);
        if (jet_passalpha_cut < 2)
        {
            continue;
        }
        // for_inclusive_sample(HT, I_ht0_nJet, I_ht0_weight, h_Bg_nJet_cut);
        ee_for_inclusive_sample(HT, jet_passalpha_cut, merge_weight, I_ht0_weight, h_Bg_nJet_cuted);
    }
    ...
    for (int evt = 0; evt < T_HT100->GetEntries(); evt++)
    {
        ...
        h_Bg_nJet->Fill(jet_passalpha_cut, I_ht100_weight * merge_weight.ee_HT100Weight);
        if (jet_passalpha_cut < 2)
        {
            continue;
        }
        h_Bg_nJet_cuted->Fill(jet_passalpha_cut, I_ht100_weight * merge_weight.ee_HT100Weight);
    }
    TTree *T_HT200;
    ...
    for (int evt = 0; evt < T_HT200->GetEntries(); evt++)
    {
        ...
        h_Bg_nJet->Fill(jet_passalpha_cut, I_ht200_weight * merge_weight.ee_HT200Weight);
        if (jet_passalpha_cut < 2)
        {
            continue;
        }
        h_Bg_nJet_cuted->Fill(jet_passalpha_cut, I_ht200_weight * merge_weight.ee_HT200Weight);
    }
    TTree *T_HT400;
    ...
    for (int evt = 0; evt < T_HT400->GetEntries(); evt++)
    {
        ...
        h_Bg_nJet->Fill(jet_passalpha_cut, I_ht400_weight * merge_weight.ee_HT400Weight);
        if (jet_passalpha_cut < 2)
        {
            continue;
        }
        h_Bg_nJet_cuted->Fill(jet_passalpha_cut, I_ht400_weight * merge_weight.ee_HT400Weight);
    }
    TTree *T_HT600;
    ...
    for (int evt = 0; evt < T_HT600->GetEntries(); evt++)
    {
        ...
        h_Bg_nJet->Fill(jet_passalpha_cut, I_ht600_weight * merge_weight.ee_HT600Weight);

        if (jet_passalpha_cut < 2)
        {
            continue;
        }
        h_Bg_nJet_cuted->Fill(jet_passalpha_cut, I_ht600_weight * merge_weight.ee_HT600Weight);
    }
    TTree *T_HT800;
    ...
    for (int evt = 0; evt < T_HT800->GetEntries(); evt++)
    {
        ...
        h_Bg_nJet->Fill(jet_passalpha_cut, I_ht800_weight * merge_weight.ee_HT800Weight);
        if (jet_passalpha_cut < 2)
        {
            continue;
        }
        h_Bg_nJet_cuted->Fill(jet_passalpha_cut, I_ht800_weight * merge_weight.ee_HT800Weight);
    }
    TTree *T_HT1200;
    ...
    for (int evt = 0; evt < T_HT1200->GetEntries(); evt++)
    {
        ...
        h_Bg_nJet->Fill(jet_passalpha_cut, I_ht1200_weight * merge_weight.ee_HT1200Weight);
        if (jet_passalpha_cut < 2)
        {
            continue;
        }
        h_Bg_nJet_cuted->Fill(jet_passalpha_cut, I_ht1200_weight * merge_weight.ee_HT1200Weight);
    }
    ...
    for (int evt = 0; evt < T_HT2500->GetEntries(); evt++)
    {
        ...
        h_Bg_nJet->Fill(jet_passalpha_cut, I_ht2500_weight * merge_weight.ee_HT2500Weight);
        if (jet_passalpha_cut < 2)
        {
            continue;
        }
        h_Bg_nJet_cuted->Fill(jet_passalpha_cut, I_ht2500_weight * merge_weight.ee_HT2500Weight);
    }
