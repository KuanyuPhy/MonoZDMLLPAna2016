...
void uu_Top_alpha(const char *scanalpha_step = "tmp", TString outputfile = "./output/tmp.root")
// void uu_HT_alpha()
{
    ...
    for (int evt = 0; evt < T_TTTo2L2Nu_tree->GetEntries(); evt++)
    {
        ...
        h_Bg_nJet->Fill(jet_passalpha_cut, I_TTTo2L2Nu_weight * merge_weight.uu_TTTo2L2NuWeight);

        if (jet_passalpha_cut < 2)
        {
            continue;
        }
        h_Bg_nJet_cuted->Fill(jet_passalpha_cut, I_TTTo2L2Nu_weight * merge_weight.uu_TTTo2L2NuWeight);
    }
    ...
    for (int evt = 0; evt < T_ST_tW_top_tree->GetEntries(); evt++)
    {
        ...
        h_Bg_nJet->Fill(jet_passalpha_cut, I_ST_tW_top_weight * merge_weight.uu_ST_tW_topWeight);

        if (jet_passalpha_cut < 2)
        {
            continue;
        }
        h_Bg_nJet_cuted->Fill(jet_passalpha_cut, I_ST_tW_top_weight * merge_weight.uu_ST_tW_topWeight);
    }
    ...
    for (int evt = 0; evt < T_ST_tW_antitop_tree->GetEntries(); evt++)
    {
        ...
        h_Bg_nJet->Fill(jet_passalpha_cut, I_ST_tW_antitop_weight * merge_weight.uu_ST_tW_antitopWeight);

        if (jet_passalpha_cut < 2)
        {
            continue;
        }
        h_Bg_nJet_cuted->Fill(jet_passalpha_cut, I_ST_tW_antitop_weight * merge_weight.uu_ST_tW_antitopWeight);
    }
    ...
    for (int evt = 0; evt < T_TTWJetsToLNu_tree->GetEntries(); evt++)
    {
        ...
        h_Bg_nJet->Fill(jet_passalpha_cut, I_TTWJetsToLNu_weight * merge_weight.uu_TTWJetsToLNuWeight);

        if (jet_passalpha_cut < 2)
        {
            continue;
        }
        h_Bg_nJet_cuted->Fill(jet_passalpha_cut, I_TTWJetsToLNu_weight * merge_weight.uu_TTWJetsToLNuWeight);
    }
    ...
    for (int evt = 0; evt < T_TTWJetsToQQ_tree->GetEntries(); evt++)
    {
        ...
        h_Bg_nJet->Fill(jet_passalpha_cut, I_TTWJetsToQQ_weight * merge_weight.uu_TTWJetsToQQWeight);

        if (jet_passalpha_cut < 2)
        {
            continue;
        }
        h_Bg_nJet_cuted->Fill(jet_passalpha_cut, I_TTWJetsToQQ_weight * merge_weight.uu_TTWJetsToQQWeight);
    }
    ...
    for (int evt = 0; evt < T_TTZToQQ_tree->GetEntries(); evt++)
    {
        ...
        h_Bg_nJet->Fill(jet_passalpha_cut, I_TTZToQQ_weight * merge_weight.uu_TTZToQQWeight);
        if (jet_passalpha_cut < 2)
        {
            continue;
        }
        h_Bg_nJet_cuted->Fill(jet_passalpha_cut, I_TTZToQQ_weight * merge_weight.uu_TTZToQQWeight);
    }
    ...
    for (int evt = 0; evt < T_TTZToLLNuNu_tree->GetEntries(); evt++)
    {
        ...
        h_Bg_nJet->Fill(jet_passalpha_cut, I_TTZToLLNuNu_weight * merge_weight.uu_TTZToLLNuNuWeight);

        if (jet_passalpha_cut < 2)
        {
            continue;
        }
        h_Bg_nJet_cuted->Fill(jet_passalpha_cut, I_TTZToLLNuNu_weight * merge_weight.uu_TTZToLLNuNuWeight);
    }
