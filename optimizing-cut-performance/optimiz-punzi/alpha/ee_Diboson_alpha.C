...
void ee_Diboson_alpha(const char *scanalpha_step = "tmp", TString outputfile = "./output/tmp.root")
{
    ...
    for (int evt = 0; evt < T_event->GetEntries(); evt++)
    {
        ...
        h_Bg_nJet->Fill(jet_passalpha_cut, f_gg_ZZ_2e2mu_weight * merge_weight.ee_diboson_gg_ZZ_2e2mu_Weight);
        if (jet_passalpha_cut < 2)
        {
            continue;
        }
        h_Bg_nJet_cuted->Fill(jet_passalpha_cut, f_gg_ZZ_2e2mu_weight * merge_weight.ee_diboson_gg_ZZ_2e2mu_Weight);
    }
    ...
    for (int evt = 0; evt < T_event1->GetEntries(); evt++)
    {
        ...
        h_Bg_nJet->Fill(jet_passalpha_cut, f_gg_ZZ_2e2nu_weight * merge_weight.ee_diboson_gg_ZZ_2e2nu_Weight);
        if (jet_passalpha_cut < 2)
        {
            continue;
        }
        h_Bg_nJet_cuted->Fill(jet_passalpha_cut, f_gg_ZZ_2e2nu_weight * merge_weight.ee_diboson_gg_ZZ_2e2nu_Weight);
    }
    ...
    for (int evt = 0; evt < T_event2->GetEntries(); evt++)
    {
        ...
        h_Bg_nJet->Fill(jet_passalpha_cut, f_gg_ZZ_2e2tau_weight * merge_weight.ee_diboson_gg_ZZ_2e2tau_Weight);
        if (jet_passalpha_cut < 2)
        {
            continue;
        }
        h_Bg_nJet_cuted->Fill(jet_passalpha_cut, f_gg_ZZ_2e2tau_weight * merge_weight.ee_diboson_gg_ZZ_2e2tau_Weight);
    }
    ...
    for (int evt = 0; evt < T_event3->GetEntries(); evt++)
    {
        ...
        h_Bg_nJet->Fill(jet_passalpha_cut, f_gg_ZZ_2mu2nu_weight * merge_weight.ee_diboson_gg_ZZ_2mu2nu_Weight);
        if (jet_passalpha_cut < 2)
        {
            continue;
        }
        h_Bg_nJet_cuted->Fill(jet_passalpha_cut, f_gg_ZZ_2mu2nu_weight * merge_weight.ee_diboson_gg_ZZ_2mu2nu_Weight);
    }
    ...
    for (int evt = 0; evt < T_event4->GetEntries(); evt++)
    {
        ...
        h_Bg_nJet->Fill(jet_passalpha_cut, f_gg_ZZ_2mu2tau_weight * merge_weight.ee_diboson_gg_ZZ_2mu2tau_Weight);
        if (jet_passalpha_cut < 2)
        {
            continue;
        }
        h_Bg_nJet_cuted->Fill(jet_passalpha_cut, f_gg_ZZ_2mu2tau_weight * merge_weight.ee_diboson_gg_ZZ_2mu2tau_Weight);
    }
    ...
    for (int evt = 0; evt < T_event5->GetEntries(); evt++)
    {
        ...
        h_Bg_nJet->Fill(jet_passalpha_cut, f_gg_ZZ_4e_weight * merge_weight.ee_diboson_gg_ZZ_4e_Weight);
        if (jet_passalpha_cut < 2)
        {
            continue;
        }
        h_Bg_nJet_cuted->Fill(jet_passalpha_cut, f_gg_ZZ_4e_weight * merge_weight.ee_diboson_gg_ZZ_4e_Weight);
    }
    ...
    for (int evt = 0; evt < T_event6->GetEntries(); evt++)
    {
        ...
        h_Bg_nJet->Fill(jet_passalpha_cut, f_gg_ZZ_4mu_weight * merge_weight.ee_diboson_gg_ZZ_4mu_Weight);
        if (jet_passalpha_cut < 2)
        {
            continue;
        }
        h_Bg_nJet_cuted->Fill(jet_passalpha_cut, f_gg_ZZ_4mu_weight * merge_weight.ee_diboson_gg_ZZ_4mu_Weight);
    }
    ...
    for (int evt = 0; evt < T_event7->GetEntries(); evt++)
    {
        ...
        h_Bg_nJet->Fill(jet_passalpha_cut, f_gg_ZZ_4tau_weight * merge_weight.ee_diboson_gg_ZZ_4tau_Weight);
        if (jet_passalpha_cut < 2)
        {
            continue;
        }
        h_Bg_nJet_cuted->Fill(jet_passalpha_cut, f_gg_ZZ_4tau_weight * merge_weight.ee_diboson_gg_ZZ_4tau_Weight);
    }
    ...
    for (int evt = 0; evt < T_event8->GetEntries(); evt++)
    {
        ...
        h_Bg_nJet->Fill(jet_passalpha_cut, f_gg_WW_2L2Nu_weight * merge_weight.ee_diboson_gg_WW_2L2Nu_Weight);
        if (jet_passalpha_cut < 2)
        {
            continue;
        }
        h_Bg_nJet_cuted->Fill(jet_passalpha_cut, f_gg_WW_2L2Nu_weight * merge_weight.ee_diboson_gg_WW_2L2Nu_Weight);
    }
    ...
    for (int evt = 0; evt < T_event9->GetEntries(); evt++)
    {
        ...
        h_Bg_nJet->Fill(jet_passalpha_cut, f_qq_WW_2L2Nu_weight * merge_weight.ee_diboson_qq_WW_2L2Nu_Weight);
        if (jet_passalpha_cut < 2)
        {
            continue;
        }
        h_Bg_nJet_cuted->Fill(jet_passalpha_cut, f_qq_WW_2L2Nu_weight * merge_weight.ee_diboson_qq_WW_2L2Nu_Weight);
    }
    ...
    for (int evt = 0; evt < T_event10->GetEntries(); evt++)
    {
        ...
        h_Bg_nJet->Fill(jet_passalpha_cut, f_qq_WZ_2L2Q_weight * merge_weight.ee_diboson_qq_WZ_2L2Q_Weight);
        if (jet_passalpha_cut < 2)
        {
            continue;
        }
        h_Bg_nJet_cuted->Fill(jet_passalpha_cut, f_qq_WZ_2L2Q_weight * merge_weight.ee_diboson_qq_WZ_2L2Q_Weight);
    }
    ...
    for (int evt = 0; evt < T_event11->GetEntries(); evt++)
    {
        ...
        h_Bg_nJet->Fill(jet_passalpha_cut, f_qq_WZ_3LNu_weight * merge_weight.ee_diboson_qq_WZ_3LNu_Weight);
        if (jet_passalpha_cut < 2)
        {
            continue;
        }
        h_Bg_nJet_cuted->Fill(jet_passalpha_cut, f_qq_WZ_3LNu_weight * merge_weight.ee_diboson_qq_WZ_3LNu_Weight);
    }
    ...
    for (int evt = 0; evt < T_event12->GetEntries(); evt++)
    {
        ...
        h_Bg_nJet->Fill(jet_passalpha_cut, f_qq_ZZ_2L2Nu_weight * merge_weight.ee_diboson_qq_ZZ_2L2Nu_Weight);
        if (jet_passalpha_cut < 2)
        {
            continue;
        }
        h_Bg_nJet_cuted->Fill(jet_passalpha_cut, f_qq_ZZ_2L2Nu_weight * merge_weight.ee_diboson_qq_ZZ_2L2Nu_Weight);
    }
    ...
    for (int evt = 0; evt < T_event13->GetEntries(); evt++)
    {
        ...
        h_Bg_nJet->Fill(jet_passalpha_cut, f_qq_ZZ_2L2Q_weight * merge_weight.ee_diboson_qq_ZZ_2L2Q_Weight);

        if (jet_passalpha_cut < 2)
        {
            continue;
        }
        h_Bg_nJet_cuted->Fill(jet_passalpha_cut, f_qq_ZZ_2L2Q_weight * merge_weight.ee_diboson_qq_ZZ_2L2Q_Weight);
    }
    ...
    for (int evt = 0; evt < T_event14->GetEntries(); evt++)
    {
        ...
        h_Bg_nJet->Fill(jet_passalpha_cut, f_qq_ZZ_4L_weight * merge_weight.ee_diboson_qq_ZZ_4L_Weight);

        if (jet_passalpha_cut < 2)
        {
            continue;
        }
        h_Bg_nJet_cuted->Fill(jet_passalpha_cut, f_qq_ZZ_4L_weight * merge_weight.ee_diboson_qq_ZZ_4L_Weight);
    }
...
int main(int argc, char *argv[])
{
    if (argc == 3)
    {
        ee_Diboson_alpha(argv[1], argv[2]);
    }
    else
    {
        cout << "ERROR" << endl;
