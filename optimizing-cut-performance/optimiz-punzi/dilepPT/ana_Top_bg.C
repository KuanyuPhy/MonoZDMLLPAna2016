...
void ana_Top_bg(TString outputfile = "Top_output.root")
{
    //---------------------
    // dilepton cut
    //---------------------
    ...
    TH1D *h_TTTo2L2Nu_pass_bg = new TH1D("h_TTTo2L2Nu_pass_bg", "", 5, 1, 5);
    h_TTTo2L2Nu_pass_bg->Sumw2();
    TH1D *h_ST_tW_top_pass_bg = new TH1D("h_ST_tW_top_pass_bg", "", 5, 1, 5);
    h_ST_tW_top_pass_bg->Sumw2();
    TH1D *h_ST_tW_antitop_pass_bg = new TH1D("h_ST_tW_antitop_pass_bg", "", 5, 1, 5);
    h_ST_tW_antitop_pass_bg->Sumw2();
    TH1D *h_TTWJetsToLNu_pass_bg = new TH1D("h_TTWJetsToLNu_pass_bg", "", 5, 1, 5);
    h_TTWJetsToLNu_pass_bg->Sumw2();
    TH1D *h_TTWJetsToQQ_pass_bg = new TH1D("h_TTWJetsToQQ_pass_bg", "", 5, 1, 5);
    h_TTWJetsToQQ_pass_bg->Sumw2();
    TH1D *h_TTZToQQ_pass_bg = new TH1D("h_TTZToQQ_pass_bg", "", 5, 1, 5);
    h_TTZToQQ_pass_bg->Sumw2();
    TH1D *h_TTZToLLNuNu_pass_bg = new TH1D("h_TTZToLLNuNu_pass_bg", "", 5, 1, 5);
    ...
    for (int evt = 0; evt < T_TTTo2L2Nu_tree->GetEntries(); evt++)
    {
        ...
        h_pass_bg->Fill(1., I_TTTo2L2Nu_weight * TTTo2L2NuWeight);
        // h_TTTo2L2Nu_pass_bg->Fill(1., I_TTTo2L2Nu_weight * TTTo2L2NuWeight);
        //-------------------
        //  Scan dilepton PT
        //-------------------
        if (f_TTTo2L2Nu_dilepPT > dilepton_cut)
        {
            h_pass_Bg_nDilepPTcut->Fill(1., I_TTTo2L2Nu_weight * TTTo2L2NuWeight);
        }
        else
        {
            h_pass_Bg_nDilepPTcut->Fill(2., I_TTTo2L2Nu_weight * TTTo2L2NuWeight);
        }
    }
    ...
    for (int evt = 0; evt < T_ST_tW_top_tree->GetEntries(); evt++)
    {
        ...
        h_pass_bg->Fill(1., I_ST_tW_top_weight * ST_tW_topWeight);
        // h_ST_tW_top_pass_bg->Fill(1., I_ST_tW_top_weight * ST_tW_topWeight);
        //-------------------
        //  Scan dilepton PT
        //-------------------
        if (f_ST_tW_top_dilepPT > dilepton_cut)
        {
            h_pass_Bg_nDilepPTcut->Fill(1., I_ST_tW_top_weight * ST_tW_topWeight);
        }
        else
        {
            h_pass_Bg_nDilepPTcut->Fill(2., I_ST_tW_top_weight * ST_tW_topWeight);
        }
    }
    ...
    for (int evt = 0; evt < T_ST_tW_antitop_tree->GetEntries(); evt++)
    {
        ...
        h_pass_bg->Fill(1., I_ST_tW_antitop_weight * ST_tW_antitopWeight);
        // h_ST_tW_antitop_pass_bg->Fill(1., I_ST_tW_antitop_weight * ST_tW_antitopWeight);
        ...
        {
            h_pass_Bg_nDilepPTcut->Fill(1., I_ST_tW_antitop_weight * ST_tW_antitopWeight);
        }
        else
        {
            h_pass_Bg_nDilepPTcut->Fill(2., I_ST_tW_antitop_weight * ST_tW_antitopWeight);
        }
    }
    ...
    for (int evt = 0; evt < T_TTWJetsToLNu_tree->GetEntries(); evt++)
    {
        ...
        h_pass_bg->Fill(1., I_TTWJetsToLNu_weight * TTWJetsToLNuWeight);
        // h_TTWJetsToLNu_pass_bg->Fill(1., I_TTWJetsToLNu_weight * TTWJetsToLNuWeight);
        ...
        {
            h_pass_Bg_nDilepPTcut->Fill(1., I_TTWJetsToLNu_weight * TTWJetsToLNuWeight);
        }
        else
        {
            h_pass_Bg_nDilepPTcut->Fill(2., I_TTWJetsToLNu_weight * TTWJetsToLNuWeight);
        }
    }
    ...
    for (int evt = 0; evt < T_TTWJetsToQQ_tree->GetEntries(); evt++)
    {
        ...
        h_pass_bg->Fill(1., I_TTWJetsToQQ_weight * TTWJetsToQQWeight);
        // h_TTWJetsToQQ_pass_bg->Fill(1., I_TTWJetsToQQ_weight * TTWJetsToQQWeight);
        //-------------------
        //  Scan dilepton PT
        //-------------------
        if (f_TTWJetsToQQ_dilepPT > dilepton_cut)
        {
            h_pass_Bg_nDilepPTcut->Fill(1., I_TTWJetsToQQ_weight * TTWJetsToQQWeight);
        }
        else
        {
            h_pass_Bg_nDilepPTcut->Fill(2., I_TTWJetsToQQ_weight * TTWJetsToQQWeight);
        }
    }
    ...
    for (int evt = 0; evt < T_TTZToQQ_tree->GetEntries(); evt++)
    {
        ...
        h_pass_bg->Fill(1., I_TTZToQQ_weight * TTZToQQWeight);
        // h_TTZToQQ_pass_bg->Fill(1., I_TTZToQQ_weight * TTZToQQWeight);
        //-------------------
        //  Scan dilepton PT
        //-------------------
        if (f_TTZToQQ_dilepPT > dilepton_cut)
        {
            h_pass_Bg_nDilepPTcut->Fill(1., I_TTZToQQ_weight * TTZToQQWeight);
        }
        else
        {
            h_pass_Bg_nDilepPTcut->Fill(2., I_TTZToQQ_weight * TTZToQQWeight);
        }
    }
    ...
    for (int evt = 0; evt < T_TTZToLLNuNu_tree->GetEntries(); evt++)
    {
        ...
        h_pass_bg->Fill(1., I_TTZToLLNuNu_weight * TTZToLLNuNuWeight);
        // h_TTZToLLNuNu_pass_bg->Fill(1., I_TTZToLLNuNu_weight * TTZToLLNuNuWeight);
        //-------------------
        //  Scan dilepton PT
        //-------------------
        if (f_TTZToLLNuNu_dilepPT > dilepton_cut)
        {
            h_pass_Bg_nDilepPTcut->Fill(1., I_TTZToLLNuNu_weight * TTZToLLNuNuWeight);
        }
        else
        {
            h_pass_Bg_nDilepPTcut->Fill(2., I_TTZToLLNuNu_weight * TTZToLLNuNuWeight);
        }
    }
