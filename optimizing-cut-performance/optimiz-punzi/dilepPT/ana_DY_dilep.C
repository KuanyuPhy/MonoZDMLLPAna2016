...
void ana_DY_dilep()
{
    ...
    h_htall_dilepPT->Draw("same");
    cout<<h_htall_dilepPT->Integral()<<endl;
    ...
    */
    ...
    l1->SetFillStyle(0);
    l1->SetTextSize(0.03);
    l1->AddEntry(h_htall_dilepPT, "HT0 to INF", "l");
    l1->Draw();
    ...
    */
    ...
    canv->SaveAs("DY_HT0toInf_dilepPT.png");
    // canv->SaveAs("DY_HTall_dilepPT2.png");
    //  canv->SaveAs("DY_HT70_Mass.png");
