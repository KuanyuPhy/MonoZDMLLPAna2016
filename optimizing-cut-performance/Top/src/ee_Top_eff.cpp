...
TH1D *TTTo2L2Nu_eepass = ((TH1D *)TTTo2L2Nufile->Get("Event_Variable/h_ee_npass"));
TH1D *TTWJetsToLNu_eepass = ((TH1D *)Top_TTWJetsToLNufile->Get("Event_Variable/h_ee_npass"));
TH1D *TTWJetsToQQ_eepass = ((TH1D *)Top_TTWJetsToQQfile->Get("Event_Variable/h_ee_npass"));
TH1D *TTZToQQ_eepass = ((TH1D *)Top_TTZToQQfile->Get("Event_Variable/h_ee_npass"));
TH1D *TTZToLLNuNu_eepass = ((TH1D *)Top_TTZToLLNuNufile->Get("Event_Variable/h_ee_npass"));
TH1D *tW_antitop_eepass = ((TH1D *)Top_tW_antitopfile->Get("Event_Variable/h_ee_npass"));
TH1D *tW_top_eepass = ((TH1D *)Top_tW_topfile->Get("Event_Variable/h_ee_npass"));
...
void ee_Top_eff(TString outputfile = "./output/Top_ee_output.root")
{
    ...
    TH1D *h_ee_pass = (TH1D *)TTTo2L2Nu_eepass->Clone("h_ee_pass");
    h_ee_pass->Add(TTWJetsToLNu_eepass);
    h_ee_pass->Add(TTWJetsToQQ_eepass);
    h_ee_pass->Add(TTZToQQ_eepass);
    h_ee_pass->Add(TTZToLLNuNu_eepass);
    h_ee_pass->Add(tW_antitop_eepass);
    h_ee_pass->Add(tW_top_eepass);
